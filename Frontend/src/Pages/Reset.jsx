...
const ResetPassword = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-8 sm:px-6 lg:px-8"> {/* Responsive padding */}
            <ToastContainer position="top-right" autoClose={5000} hideProgressBar={false} newestOnTop={false} closeOnClick rtl={false} pauseOnFocusLoss draggable pauseOnHover />
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg w-full max-w-md relative"> {/* Responsive padding and max-width */}
                ...
                <h2 className="text-2xl font-bold text-center text-gray-700 mb-4 sm:mb-6"> {/* Responsive margin-bottom */}
                    Reset Password
                </h2>
